...
namespace QuickClique {
    ...
    */
    ...
    HybridAlgorithm::HybridAlgorithm(std::vector<std::list<int>> const &adjacencyList)
            : Algorithm("hybrid"), m_AdjacencyList(adjacencyList), m_pDegree(nullptr) {
    ...
    */
    ...
    long HybridAlgorithm::listAllMaximalCliquesHybrid(vector<list<int>> const &adjList,
        ...
        int *scratch = (int *) Calloc(size, (int)sizeof(int));
